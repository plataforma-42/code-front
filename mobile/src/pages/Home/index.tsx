...
const Home = () => {
  ...
  function handleNavigatepoints() {
    navigation.navigate('Companies', { uf: selectedUf, city: selectedCity });
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.main}>
        ...
        <Text style={styles.title}>Sua Plataforma de integração</Text>
        <Text style={styles.description}>Ajudamos trabalhadores a encontrarem capacitações e vagas.</Text>
      </View>
